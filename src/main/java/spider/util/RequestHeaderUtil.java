...
public class RequestHeaderUtil {
	...
	public static Map<String, String> getRandomHeader(String requestUrl) {
		Map<String, String> header = new HashMap<>(6);
		header.put("Host", requestUrl);
		header.put("User-Agent", userAgents[(int) (Math.random() * userAgents.length)]);
